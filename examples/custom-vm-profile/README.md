...
# Custom VM Profile Example

This example demonstrates configuring a custom VM profile for the image build with a larger VM size, custom OS disk size, and VM boot optimization.
